            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">วิทยากร</h1>
                    </div>
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_array($res)) { ?>
                                        <tr>
                                            ...
                                            <td><a class="btn btn-warning" href="lecturer_form_edit.php?id_card=<?php echo $row["id_card"]; ?>"><i class="fas fa-edit"></i></a></td>
