        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    $industrial_area = $row["industrial_area"];
                    ?>
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">แก้ไขข้อมูลผู้ใช้งาน</h1>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="salary" id="salary" class="form-control" value="<?php echo $row["salary"]; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        let industrial_area = '<?php echo $industrial_area; ?>'
        $("#prefix").val(prefix)
        $("#education_level").val(education_level)
        $("#industry").val(industry)
        $("#job_position").val(job_position)
        $("#department").val(department)
        $("#industrial_area").val(industrial_area)
