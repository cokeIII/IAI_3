...
<body>
    ...
    <div class="super_container">
        ...
        <div class="teachers page_section mt-custom">
            <div class="container">

                <div class="row text-white">
                    <div class="col-md-12 bg-main rounded">
                        <div class="col-md-12 bg-main">
                            <div class="text-head box">Register</div>
                        </div>
                        <div class="box-register p-5 mt-3 shadow ">
                            <form id="form-regis" method="POST" enctype="multipart/form-data">
                                ...
                                <button type="submit" class="btn bg-secondary float-right text-white">สมัครสมาชิก</button>
                            </form>
                        </div>
                        <hr>
                    </div>
